import pandas as pd
def find_lowest_cost_vm(memory_gb, vcpu_cores, pricesheet_df, rightsizing_df):
...
def main():
    ...
    vm1 = find_lowest_cost_vm(15, 4, pricesheet_df, rightsizing_df)
    if vm1 is not None:
        print("VM 1 - Linux:")
        print(vm1)

    vm2 = find_lowest_cost_vm(30, 2, pricesheet_df, rightsizing_df)
    if vm2 is not None:
        print("VM 2 - Windows:")
        print(vm2)

    vm3 = find_lowest_cost_vm(5, 1, pricesheet_df, rightsizing_df)
    if vm3 is not None:
        print("VM 3 - Linux:")
        print(vm3)

    vm4 = find_lowest_cost_vm(60, 6, pricesheet_df, rightsizing_df)
    if vm4 is not None:
        print("VM 4 - Windows:")
        print(vm4)
